...
```bash
INIT=$(node "/home/glow/Documentos/projetos/SoundGrabber2.0/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/glow/Documentos/projetos/SoundGrabber2.0/.codex/get-shit-done/templates/spec.md.
