...
```bash
INIT=$(node "/home/glow/Documentos/projetos/SoundGrabber2.0/.codex/get-shit-done/bin/gsd-tools.cjs" init plan-phase "$PHASE")
...
```bash
PHASE_INFO=$(node "/home/glow/Documentos/projetos/SoundGrabber2.0/.codex/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
```
...
```bash
node "/home/glow/Documentos/projetos/SoundGrabber2.0/.codex/get-shit-done/bin/gsd-tools.cjs" state planned-phase --phase "${PHASE}" --name "${phase_name}" --plans "${PLAN_COUNT}"
```
