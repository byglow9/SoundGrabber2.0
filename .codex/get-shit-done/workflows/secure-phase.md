...
```
Agent(
  prompt="Read /home/glow/Documentos/projetos/SoundGrabber2.0/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/glow/Documentos/projetos/SoundGrabber2.0/.codex/get-shit-done/templates/SECURITY.md`
