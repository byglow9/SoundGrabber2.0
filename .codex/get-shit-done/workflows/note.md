...
- **Global scope**: `/home/glow/Documentos/projetos/SoundGrabber2.0/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/glow/Documentos/projetos/SoundGrabber2.0/.codex/notes/`)
...
2. Glob `/home/glow/Documentos/projetos/SoundGrabber2.0/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/home/glow/Documentos/projetos/SoundGrabber2.0/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/glow/Documentos/projetos/SoundGrabber2.0/.codex/notes/` — works in any directory
