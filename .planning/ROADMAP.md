...
Plans:
**Wave 1**
- [ ] 14-01-PLAN.md — Wave 0 (TDD RED): criar tests/test_deploy_sh.py com 8 stubs RED cobrindo AUTH-04 (bind mount no compose + .env.example) e AUTH-05 (deploy.sh: set -e, chmod 750, git pull, docker compose up, sem eval)
...
| 14. Pipeline E2E on Notebook | 0/4 | Planned | - |
